...
function Assert.is_string(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a string but passed ' ..
                          type(value)))
...
function Assert.is_number(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a number but passed ' ..
                          type(value)))
...
function Assert.is_function(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a function but passed ' ..
                          type(value)))
...
function Assert.is_boolean(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a boolean but passed ' ..
                          type(value)))
...
function Assert.is_table(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a table but passed ' .. type(value)))
...
function Assert.is_nil(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a nil but passed ' .. type(value)))
...
function Assert.is_true(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a true but passed ' ..
                          tostring(value)))
...
function Assert.is_false(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a false but passed ' ..
                          tostring(value)))
...
function Assert.is_truthy(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a truthy but passed ' ..
                          tostring(value)))
...
function Assert.is_falsy(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to be a falsy but passed ' ..
                          tostring(value)))
...
function Assert.is_not_instance_of(_, cls, value, message, class_name)
    message = class_name and Assert.get_message(
                  ('expected value not to be an instance of ' + class_name) or
                      'expected value not to be an instance of the passed class')
...
function Assert.is_primitive(_, value, message)
    message = Assert.get_message(
                  message or
                      ('expected value to a primitive but passed ' ..
                          type(value)))
...
function Assert.is_instance_of_any(_, classes, value, message, class_name)
    local matching_classes = List(classes):filter(
                                 function(cls)
