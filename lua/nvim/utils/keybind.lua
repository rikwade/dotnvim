...
Keybind.add_global_keybinds = function(keybinds)
    for _, keybind in pairs(keybinds) do
        ...
        API.nvim_set_keymap(keybind[1], keybind[2], keybind[3], keybind[4])
    end
end
...
Keybind.add_buffer_keybinds = function(keybinds)
    for _, keybind in pairs(keybinds) do
        ...
        API.nvim_buf_set_keymap(keybind[1], keybind[2], keybind[3],
                                    keybind[4], keybind[5])
    end
end
...
Keybind.remove_global_keybinds = function(keybinds)
    for _, keybind in pairs(keybinds) do
        API.nvim_del_keymap(keybind[1], keybind[2])
    end
end
